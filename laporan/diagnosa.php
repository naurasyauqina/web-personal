...
function menu2(){
	...
	<img src='/pakar/gambar/banner6.jpg' alt='pakar' class='img img-responsive'>
...
?>
<?php
if($_SESSION['id_tipe'] == 1) echo "<td>Id User</td>";
?>
...
<a href="laporan_diagnosa.php" target="_blank"> Cetak Hasil</a>
<?php
